################################################################
# NOTES: 
# This rules apply to you if you are accessing an ISP using an EPAK or PEAK
# number (0965-) in a city that is more than 80 km from your own and not in the same perfecture.
# The costs for an EPAK Zone 1 long distance phone-call are:
# 1 Unit (7.0+18%VAT=8.26Drs) every 6.77secs.
# Exception1: 22:00 - 08:00 :1 Unit every 7 minutes (420secs).
# Exception2: Sunday 22:00 - 08:00 :1 Unit every 8.61secs.
################################################################
#                             Achilleas Kotsis 
...
# "unit", while "6.77" is the duration in seconds.
# Therefore the following rule means: "Every 6.77 seconds 8.26
...
# are 8.26 each 8.61 seconds"
on (sunday) between (22:00..08:00) use (8.26, 11.83)
