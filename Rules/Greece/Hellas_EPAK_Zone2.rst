...
# number (0965-) in a city that is 45 - 80 km from your own and not in the same perfecture.
# The costs for an EPAK Zone 1 long distance phone-call are:
# 1 Unit (7.0+18%VAT=8.26Drs) every 9.33secs.
# Exception1: 22:00 - 08:00 :1 Unit every 7 minutes (420secs).
# Exception2: Sunday 22:00 - 08:00 :1 Unit every 11.83secs.
################################################################
#                             Achilleas Kotsis 
...
# "unit", while "9.33" is the duration in seconds.
# Therefore the following rule means: "Every 9.33 seconds 8.26
