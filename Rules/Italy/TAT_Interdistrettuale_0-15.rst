...
#
# TAT_Interdistrettuale_0-15.rst
#
#
...
##							      ##
## Tariffa RIDOTTA:	£ 60,96 al minuto		      ##
## Tariffa INTERA:	£ 121,92 al minuto		      ##
##							      ##
...
# Nome ruleset
name=TAT_Interdistrettuale_0-15
...
on (monday..friday) between (8:00..18:30) use (121.92, 60)
on (saturday) between (8:00..13:00) use (121.92, 60)

# Nelle festivita' si applica la tariffa ridotta
on (01/01) between () use (60.96, 60)
on (01/06) between () use (60.96, 60)
on (04/25) between () use (60.96, 60)
on (05/01) between () use (60.96, 60)
on (08/15) between () use (60.96, 60)
on (11/01) between () use (60.96, 60)
on (12/08) between () use (60.96, 60)
on (12/25) between () use (60.96, 60)
on (easter + 1) between () use (60.96, 60)
