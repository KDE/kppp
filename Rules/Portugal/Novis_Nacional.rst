################################################################
#
#        Chamadas Nacionais via Novis (1010)
#        origem: Continente
#        
#        changes 2000-01-02
...
name=Novis Nacional (Continente)
...
on (monday..friday) between (9:00..21:00) use (23.4, 60)
on (monday..friday) between (9:00..21:00) use (0.39, 1, 60)
