...
# nyårsdagen
on (01/01) between () use (0.0028333333333, 1)
# trettondag jul
on (01/06) between () use (0.0028333333333, 1)
# långfredagen
on (easter-2) between () use (0.0028333333333, 1)
# annandag påsk
on (easter+1) between () use (0.0028333333333, 1)
# första maj
on (05/01) between () use (0.0028333333333, 1)
# kristi himmelfärds dag
on (easter+39) between () use (0.0028333333333, 1)
# annandag pingst
on (easter+50) between () use (0.0028333333333, 1)
# juldagen
on (12/25) between () use (0.0028333333333, 1)
# annandag jul
on (12/26) between () use (0.0028333333333, 1)

# "aftnar" (osäkert om följande är korrekt & fullständigt)
# trettondagsafton
on (01/05) between () use (0.0028333333333, 1)
# julafton
on (12/24) between () use (0.0028333333333, 1)
# nyårsafton
on (12/31) between () use (0.0028333333333, 1)
