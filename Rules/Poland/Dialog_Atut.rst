##################################################################
# Koszty polaczen z Internetem w sieci Dialog - Atut
...
on (monday..friday) between (18:00..7:59) use (0.52, 420)
# Impuls w sobote i niedziele naliczany jest co 7 minut przez cala dobe
on (saturday..sunday) between () use (0.52, 420)
# Swieta
on (01/01, 05/01, 05/03, 08/15, 11/01, 11/11, 12/25, 12/26) between () use (0.52, 420)
