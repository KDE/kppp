...
# Ces tarifs m'ont été donnés par France Télécom
# le 11 Août 2000.
#
...
#
# 0.79 F TTC en tarif réduit
# 0.40 F TTC in tarif normal
#
...
on (monday..friday)	between (00:00..07:59) use (0.40, 60)
on (monday..friday)	between	(08:00..18:59) use (0.79, 60)
on (monday..friday)	between (19:00..23:59) use (0.40, 60)

on (saturday..sunday)	between (00:00..23:59) use (0.40, 60)

# Jours fériés :-))
on (01/01, easter+1, 05/01, 05/08, easter+38, easter+50, 07/14, 08/15, 11/01, 11/11, 12/25) between (00:00..23:59) use (0.40, 60)
